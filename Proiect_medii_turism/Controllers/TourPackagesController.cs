...
namespace Proiect_medii_turism.Controllers
{
    public class TourPackagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PackageId,Name,Destination,Price,LeavingDate,ReturnDate")] TourPackage tourPackage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PackageId,Name,Destination,Price,LeavingDate,ReturnDate")] TourPackage tourPackage)
        {
